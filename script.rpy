...
label start:
    ...
    g "Привет, извини что так долго, бабушки у подъезда не хотели меня пускать..."
    ...
    scene kids kitchen
    a "Гена и Максимилиан объелись блинов, после чего начали играть в компьютер."
...
label ten_years_later:
    ...
    menu:
        ...
        "Максимилиан":
            call MaxStory from _call_MaxStory
        "Гена":
            call GenaStory from _call_GenaStory
    scene the end
    with fade
...
label Walk:
    ...
    call Project from _call_Project
    return
...
label NotWalk:
    ...
    call Project from _call_Project_1
    return
...
label Project:
    ...
    call Weekend from _call_Weekend
    return
...
label Weekend:
    ...
    call Session from _call_Session
    return
...
label Session:
    ...
    call KatyaNotice from _call_KatyaNotice
    return
...
label KatyaNotice:
    ...
    call MaxFinal from _call_MaxFinal
    return
...
label MaxFinal:
    ...
    if MaxFinalFamilyVar >= 4:
        call MaxFinalFamily from _call_MaxFinalFamily
    elif MaxFinalFriendsVar >= 2:
        call MaxFinalFamily from _call_MaxFinalFamily_1
    else:
        call MaxFinalFirm from _call_MaxFinalFirm
    return
...
label GenaStory:
    ...
    menu:
        ...
        "Офлайн":
            call Offline from _call_Offline
        "Онлайн":
            call Online from _call_Online
    return
...
label Offline:
    ...
    call Online from _call_Online_1
    return
...
label Online:
    ...
    menu:
        ...
        "Команда":
            call Team from _call_Team
        "Трудоустройство":
            call Job from _call_Job
